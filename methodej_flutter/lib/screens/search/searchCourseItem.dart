...
class SearchCourseItem extends StatefulWidget {
  SearchCourseItem({this.item});
  final item;
  @override
  State<SearchCourseItem> createState() =>
      _SearchCourseItemState(item: this.item);
}

class _SearchCourseItemState extends State<SearchCourseItem> {
  _SearchCourseItemState({required this.item});
